...
#define MSG_PREHEAT_1_SETTINGS              _UxGT("DefiniÃ§Ãµes PLA")
...
#define MSG_PREHEAT_2_SETTINGS              _UxGT("DefiniÃ§Ãµes ABS")
...
#define MSG_A_RETRACT                       _UxGT("A-retracÃ§Ã£o")
...
#define MSG_RESUME_PRINT                    _UxGT("Retomar impressÃ£o")
...
#define MSG_USERWAIT                        _UxGT("Ã� espera de ordem")
#define MSG_PRINT_ABORTED                   _UxGT("ImpressÃ£o cancelada")
#define MSG_NO_MOVE                         _UxGT("Sem movimento")
#define MSG_KILLED                          _UxGT("EMERGÃŠNCIA. ")
...
#define MSG_INIT_SDCARD                     _UxGT("Inici. cartÃ£o SD")
#define MSG_CNG_SDCARD                      _UxGT("Trocar cartÃ£o SD")
...
#define MSG_ERR_MAXTEMP                     _UxGT("Err: T MÃ¡xima")
#define MSG_ERR_MINTEMP                     _UxGT("Err: T MÃ­nima")
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Err: T Base MÃ¡xima")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Err: T Base MÃ­nima")
#define MSG_HEATING                         _UxGT("Aquecendo...")
#define MSG_BED_HEATING                     _UxGT("Aquecendo base...")
#define MSG_DELTA_CALIBRATE                 _UxGT("CalibraÃ§Ã£o Delta")
