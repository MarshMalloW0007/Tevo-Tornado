...
#define MSG_DISABLE_STEPPERS                _UxGT("SlÃ¥ alle steppere fra")
...
#define MSG_LEVEL_BED_WAITING               _UxGT("Klik nÃ¥r du er klar")
#define MSG_LEVEL_BED_NEXT_POINT            _UxGT("NÃ¦ste punkt")
#define MSG_LEVEL_BED_DONE                  _UxGT("Bed level er fÃ¦rdig!")
#define MSG_SET_HOME_OFFSETS                _UxGT("SÃ¦t forsk. af home")
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("Forsk. er nu aktiv")
#define MSG_SET_ORIGIN                      _UxGT("SÃ¦t origin")
...
#define MSG_COOLDOWN                        _UxGT("AfkÃ¸l")
#define MSG_SWITCH_PS_ON                    _UxGT("SlÃ¥ strÃ¸m til")
#define MSG_SWITCH_PS_OFF                   _UxGT("SlÃ¥ strÃ¸m fra")
...
#define MSG_FAN_SPEED                       _UxGT("BlÃ¦ser hastighed")
...
#define MSG_MOTION                          _UxGT("BevÃ¦gelse")
...
#define MSG_USERWAIT                        _UxGT("Venter pÃ¥ bruger...")
#define MSG_PRINT_ABORTED                   _UxGT("Print annulleret")
#define MSG_NO_MOVE                         _UxGT("Ingen bevÃ¦gelse.")
#define MSG_KILLED                          _UxGT("DRÃ†BT. ")
#define MSG_STOPPED                         _UxGT("STOPPET. ")
#define MSG_CONTROL_RETRACT                 _UxGT("TilbagetrÃ¦k mm")
#define MSG_CONTROL_RETRACT_SWAP            _UxGT("Skift Re.mm")
#define MSG_CONTROL_RETRACTF                _UxGT("TilbagetrÃ¦k V")
...
#define MSG_THERMAL_RUNAWAY                 _UxGT("Temp lÃ¸ber lÃ¸bsk")
...
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("ForsÃ¦t print")

#if LCD_HEIGHT >= 4
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Vent pÃ¥ start")
  #define MSG_FILAMENT_CHANGE_INIT_2          _UxGT("af filament")
  #define MSG_FILAMENT_CHANGE_INIT_3          _UxGT("skift")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Vent pÃ¥")
  #define MSG_FILAMENT_CHANGE_UNLOAD_2        _UxGT("filament udskyd.")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("IndsÃ¦t filament")
  #define MSG_FILAMENT_CHANGE_INSERT_2        _UxGT("og tryk pÃ¥ knap")
  #define MSG_FILAMENT_CHANGE_INSERT_3        _UxGT("for at fortsÃ¦tte...")
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("Vent pÃ¥")
  #define MSG_FILAMENT_CHANGE_LOAD_2          _UxGT("filament indtag")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("Vent pÃ¥ at print")
  #define MSG_FILAMENT_CHANGE_RESUME_2        _UxGT("fortsÃ¦tter")
#else // LCD_HEIGHT < 4
  #define MSG_FILAMENT_CHANGE_INIT_1          _UxGT("Vent venligst...")
  #define MSG_FILAMENT_CHANGE_UNLOAD_1        _UxGT("Udskyder...")
  #define MSG_FILAMENT_CHANGE_INSERT_1        _UxGT("IndsÃ¦t og klik")
  #define MSG_FILAMENT_CHANGE_LOAD_1          _UxGT("Indtager...")
  #define MSG_FILAMENT_CHANGE_RESUME_1        _UxGT("FortsÃ¦tter...")
#endif // LCD_HEIGHT < 4
