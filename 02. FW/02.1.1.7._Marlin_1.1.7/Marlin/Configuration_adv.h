...
#define EXTRUDER_AUTO_FAN_TEMPERATURE 100   // Don't turn case fan on until extruder is at 100 deg
#define EXTRUDER_AUTO_FAN_SPEED  127         // Run the fans at a quieter speed
