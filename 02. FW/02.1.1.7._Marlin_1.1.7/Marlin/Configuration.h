...
#define STRING_CONFIG_H_AUTHOR "(lemmingDev, TT FBook Grp)" // Who made the changes.
#define SHOW_BOOTSCREEN
//#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
//#define STRING_SPLASH_LINE2 WEBSITE_URL         // will be shown during bootup in line 2
#define STRING_SPLASH_LINE1 "TEVO Tornado" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "V1.17"    // will be shown during bootup in line 2
//
// *** VENDORS PLEASE READ *****************************************************
//
