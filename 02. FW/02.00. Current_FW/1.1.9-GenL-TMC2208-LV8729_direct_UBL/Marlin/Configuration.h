...
#define STRING_CONFIG_H_AUTHOR "(pemic, Tevo Tornado)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Tevo Tornado E3D V6 clone silicone sock
  #define DEFAULT_Kp 33
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 129
  #define DEFAULT_bedKi 17
  #define DEFAULT_bedKd 247
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80.08, 400, 410 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 250, 220, 25, 65 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1200, 120, 9000 }
 ...
 */
#define S_CURVE_ACCELERATION //ppp
...
#define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST / 2.2)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_HOTEND_TEMP  208.0  // (Â°C) Default nozzle temperature for the G26 Mesh Validation Tool.
    #define MESH_TEST_BED_TEMP      55.0  // (Â°C) Default bed temperature for the G26 Mesh Validation Tool.
  #endif
