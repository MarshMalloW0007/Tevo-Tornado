...
#define STRING_CONFIG_H_AUTHOR "(cYr, TEVO TORNADO 1.1.9)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Tevo Tornado"                 // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "v1.1.9 By cYr"                // will be shown during bootup in line 2
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //TEVO Tornado
  #define DEFAULT_Kp 17.74 // old 20.37
  #define DEFAULT_Ki 1.16  // old 1.50
  #define DEFAULT_Kd 67.58 // old 69.26
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //TEVO Tornado
  #define  DEFAULT_bedKp 90.37  // old 128.82
  #define  DEFAULT_bedKi 15.11  // old 16.91
  #define  DEFAULT_bedKd 135.11 // old 245.36
...
#define EXTRUDE_MAXLENGTH 300 //200
...
#define Z_HOMING_HEIGHT 10  // was 5 - (in mm) Minimal z height before homing (G28) for Z clearance above the bed, clamps, ...
